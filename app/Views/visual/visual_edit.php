                ...
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col-12">
                                <form action="<?= base_url('admin/visual/update')?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="hidden" name="file_visual_lama" value="<?=$visual[0]->nama_file?>">
                                            <input type="file" name="file_visual" class="custom-file-input <?= ($validation->hasError('file_visual') ? 'is-invalid' : '')?>" id="" accept=".pdf">
